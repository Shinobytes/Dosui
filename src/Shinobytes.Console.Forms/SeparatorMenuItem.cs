...
namespace Shinobytes.Console.Forms
{
    public class SeparatorMenuItem : MenuItem
    {
        public override void Draw(IGraphics graphics, AppTime appTime)
        {
            ...
            graphics.DrawLine(isThin ? AsciiCodes.BorderSingle_Horizontal : AsciiCodes.BorderDouble_Horizontal,
                this.Position.X, this.Position.Y, this.Position.X + this.Size.Width - 1, this.Position.Y,
                this.BorderColor, this.BackgroundColor);

            graphics.SetPixel(isThin ? AsciiCodes.BorderSingle_SplitToRight : AsciiCodes.BorderDouble_SplitToRight,
                this.Position.X - 1, this.Position.Y, this.BorderColor, this.BackgroundColor);

            graphics.SetPixel(isThin ? AsciiCodes.BorderSingle_SplitToLeft : AsciiCodes.BorderDouble_SplitToLeft,
